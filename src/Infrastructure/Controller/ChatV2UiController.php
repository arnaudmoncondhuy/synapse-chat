...
/**
 * Contrôleur UI de chat v2 fourni par le bundle Chat.
 *
 * Expose la route `/synapse/chat-v2` pour tester la nouvelle interface.
 */
#[Route('%synapse.chat_ui_prefix%-v2', name: 'synapse_chat_v2', methods: ['GET'])]
class ChatV2UiController extends AbstractController
{
